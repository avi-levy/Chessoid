...
<html>
    ...
    <body>
        <!--  this div is the button bar below the grails logo (originally) -->
        <div class="nav">
        ...
        <div class="body">
            ...
            <!--  display flash messages (usually error messages) if any -->
                ...
                <table>
                    ...
                    <g:each in="${tekEventInstanceList}" status="i" var="tekEventInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
                            	<%-- <g:link action="show" id="${tekEventInstance.id}">${fieldValue(bean: tekEventInstance, field: "id")}</g:link> --%>
