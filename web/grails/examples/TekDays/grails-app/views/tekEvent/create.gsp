                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <%-- 
                                	Note that we're calling the hasErrors 'method' here - it's the same as the <g:hasErrors>
                                	tag.  Under the hood GSP tags are really closures, and we can treat them like
                                	methods whenever that's more convenient.
                                --%>
