            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="song.duration.label" default="Duration" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: songInstance, field: "duration")}</td>
