                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="song"><g:message code="album.song.label" default="Song" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: albumInstance, field: 'song', 'errors')}">
                                    
<ul>
<g:each in="${albumInstance?.song?}" var="s">
